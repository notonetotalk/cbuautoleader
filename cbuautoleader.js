  ...
  var dart = [["_foreign_helper", "dart:_foreign_helper",, H, {
    ...
    changeCodeTree: [function($event) {
      ...
      if (H.interceptedTypeCast(document.querySelector("#radioMadisons"), "$isRadioButtonInputElement").checked === true) {
        t1 = P.LinkedHashMap__makeLiteral(["", "AAA", "0", "BBB", "00", "CCC", "01", "ABC", "010", "CCB", "011", "BCC", "012", "CBC", "02", "ABC", "020", "BCB", "021", "CBB", "022", "BBC", "1", "ABC", "10", "BAB", "100", "CCA", "101", "BCA", "102", "CAB", "11", "BBA", "110", "ACB, or CAC if not.", "1100", "CAC", "111", "BAC", "112", "CBA", "12", "ABB, or ACC if not.", "121", "ACC", "2", "ABC", "20", "BAA, or CAA if not.", "202", "CAA", "21", "AAB, or ACA if not.", "211", "ACA", "22", "ABA, or AAC if not.", "221", "AAC"]);
        $.codeTree = t1;
      } else {
  ...
  (function(callback) {
    ...
    if (typeof dartMainRunner === "function")
      dartMainRunner(function(a) {
        H.startRootIsolate(B.cbuautoleader__main$closure(), a);
      }, []);
    else
      (function(a) {
        H.startRootIsolate(B.cbuautoleader__main$closure(), a);
